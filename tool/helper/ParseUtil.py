...
class ParseUtil:
    ...
    def __to_int(cls,\
        ...
        if value is None:
            return ParseUtilResult[int].fail()
        # Hard check
        if hard is not None:
        ...
        if softmin is not None and value < softmin:
            return ParseUtilResult[int].tolo()
        if softmax is not None and value > softmax:
            return ParseUtilResult[int].tohi()
        # Success!!!
        return ParseUtilResult[int].passs(value)
    ...
    def to_float(cls,\
        ...
        except: return ParseUtilResult[float].fail()
        # Range check
        if min is not None and value < min:
            return ParseUtilResult[float].tolo()
        if max is not None and value > max:
            return ParseUtilResult[float].tohi()
        # Success!!!
        return ParseUtilResult[float].passs(value)
